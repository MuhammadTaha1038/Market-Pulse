...
async def create_preset(preset: PresetCreate):
    ...
    try:
        ...
        logging_service.add_log(
            module='presets',
            action='create',
            description=f"Created preset '{preset.name}'",
...
async def update_preset(preset_id: int, preset: PresetUpdate):
    ...
    try:
        ...
        logging_service.add_log(
            module='presets',
            action='update',
            description=f"Updated preset '{updated.get('name', preset_id)}'",
            entity_id=preset_id,
            entity_name=updated.get('name', str(preset_id))
        )
        return {
            "message": "Preset updated successfully",
            "preset": updated
...
async def delete_preset(preset_id: int):
    ...
    try:
        ...
        logging_service.add_log(
            module='presets',
            action='delete',
            description=f"Deleted preset #{preset_id}",
            entity_id=preset_id
        )
